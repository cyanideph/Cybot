"""Minimal Supabase adapter used by the Pydroid bot."""
...
class Database:
    ...
    def poll_messages(self) -> list[dict[str, Any]]:
        r = (self.client.table("room_messages")
        ...
        return [x for x in rows
                if str(x.get("sender_id") or "") != BOT_SENDER_ID
                and str(x.get("sender") or "").casefold() != BOT_NAME.casefold()]
